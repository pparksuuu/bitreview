...
// => 그러나 이 인터페이스를 직접 구현하려면 많은 메서드를 구현해야 한다.
// => 그래서 자바는 PropertyEditor를 미리 구현한 PropertyEditorSupport라는 클래스를 제공
...
public class CustomDateEditor extends PropertyEditorSupport {
	...
	public void setAsText(String text) throws IllegalArgumentException {
		...
		// => 그러면 스프링 IoC 컨테이너에서 이 값을 꺼내서 객체에 주입
	...
	public Object getValue() {
		// 이 메서드는 호출되었을 때 그것을 표시하기 위해 오버라이딩
