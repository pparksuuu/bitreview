...
public class Exam01 {
	public static void main(String[] args) {
		...
		// ApplicationContext 구현체(implementations) 종류
		// 1) XML 파일에 작성된 설정 정보를 읽어서 처리하는 IoC 컨테이너
		//    => ClassPathXmlApplicationContext (자바 classpath에서 xml파일 읽어옴)
		//    => FileSystemXmlApplicationContext (OS 파일시스템에서 xml 파일을 읽어옴)
		...
		// => 설정 파일에 지정된 객체를 자동으로 생성하고 의존 객체를 주입하여 보관
		iocContainer = new ClassPathXmlApplicationContext(
				"bitcamp/java106/step01_1/application-context.xml");
