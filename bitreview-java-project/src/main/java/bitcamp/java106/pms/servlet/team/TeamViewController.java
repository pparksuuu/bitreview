...
public class TeamViewController extends HttpServlet {
    ...
    protected void doGet(
        ...
        try {
            ...
            if (team == null) {
                ...
                out.println("<tr>");
                out.printf("   <th>아이디</th><td><input type='text' name='name' value='%s' readonly></td></tr>\n",
                        team.getName());
                out.println("<tr>");
                out.print("   <th>설명</th><td><textarea name='description' rows='6' cols='60'>");
                out.printf("%s</textarea></td>\n", 
                        team.getDescription());
                out.println("</tr>");
                out.println("<tr>");
